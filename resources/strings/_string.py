...
DEFAULTUSER = str(Name) if Name else "RAMBO THON"
...
Start = (
    """
    <------------------------------------>
         يتم تحميل ملفات السورس رامبو ثـون
    <------------------------------------>
    """
)
...
C = "**⌔╎المعادله ⪼** {}\n  **- الحل ⪼** {}"
Calc = (
    "𓆰 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐀𝐌𝐁𝐎 𝐓𝐇𝐎𝐍 ✹ - 𝑪𝑨𝑳𝑪𝑼𝑳𝑨𝑻𝑶𝑹 𓆪\n"
    "◐━─━─━─━─**𝐑𝐀𝐌𝐁𝐎 𝐓𝐇𝐎𝐍 ✹**─━─━─━─━◐\n"
    "**⌔╎قائـمه اوامر الحاسبه :** \n"
    "⪼ `.حاسبه` + المعادله \n"
    "◐━─━─━─━─**𝐑𝐀𝐌𝐁𝐎 𝐓𝐇𝐎𝐍 ✹**─━─━─━─━◐\n"
    "𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐀𝐌𝐁𝐎 𝐓𝐇𝐎𝐍 ✹ - [𝘿𝙀𝙑](t.me/nnnnh) 𓆪"
)
...
StartLoaded = "<ⵧⵧⵧⵧⵧⵧ⫷ - RAMBO PLUGINS - ⫸ⵧⵧⵧⵧⵧⵧ>"
ASSISTANT = "<ⵧⵧⵧⵧⵧⵧ⫷ - RAMBO ASSISTANT - ⫸ⵧⵧⵧⵧⵧⵧ>"
KIMOTOSHA = "<ⵧⵧⵧⵧⵧⵧⵧⵧ⫷ - RAMBO TOSHA - ⫸ⵧⵧⵧⵧⵧⵧⵧ>"
ANIMATIONS = "<ⵧⵧⵧⵧⵧⵧ⫷ - RAMBO ANIMATIONS - ⫸ⵧⵧⵧⵧⵧ>"
ADMIN = "<ⵧⵧⵧⵧⵧ⫷ - RAMBO ADMIN TOOLS - ⫸ⵧⵧⵧⵧⵧ>"
ASSISTANTPM = "<ⵧⵧⵧⵧⵧ⫷ - RAMBO ASSISTANT PM - ⫸ⵧⵧⵧⵧⵧ>"
...
⫷ بوت رامبو ثـون يعمل بنجاح الان ⫸
   ⫷ المستخدم: {} - البوت: {} ⫸
   ⫷ ارجع الى حسابك ودز الامر (.الاوامر) ⫸
⫷ @RAMBO_SYR - اذا كنت بحاجه الى مساعده فتوجه الى ⫸
⫷ @NNNNH - تحياتي :  ⫸"""
)

Mesg = [
    '⫷ يتم تحميل انلاين رامبو ثـون ⫸',
    '⫷ اكتمل تنزيل انلاين رامبو ثـون بدون اخطاء ⫸',
    '⫷ يتم بدء بوت رامبو ثـون ⫸',
    '⫷ اكتمل بدء بوت رامبو ثـون ⫸'
]
...
Echo = [
    ...
    '𓆩 𝗦𝗢𝗨𝗥𝗖𝗘 𝐑𝐀𝐌𝐁𝐎 𝐓𝐇𝐎𝐍 ✹ - 𝑬𝑪𝑯𝑶 𝑳𝑰𝑺𝑻 𓆪\n◐━─━─━─━─**𝐑𝐀𝐌𝐁𝐎 𝐓𝐇𝐎𝐍 ✹**─━─━─━─━◐\n**⌔╎قائمة المضافين للازعاج:**\n',
    '**- ايدي المستخدم :** `{}`\n**- ايدي الـمجموعه :** `{}`\n\n',
